...
boot.se= link.boot.se(x)
boot.se
#### Error of equating -  bootstrap
# 0.2928948   0.6179196   0.5526686
cor(x_equated[[1]]$totalScore1, true.ability$th)
cor(x_equated[[1]]$totalScore2, true.ability$th)
cor(x_equated[[1]]$totalScore3, true.ability$th)

## New scores
colMeans(data_3nodes[,-1], na.rm = T)
...
plot(1:length(x_equated[[1]][,2]),x_equated[[1]][,2])
plot(x[,3],x_equated[[1]][,4])
plot(x[,2],x_equated[[1]][,3])

## Correlate with true ability
plot(x[,2],x_equated[[1]][,3])
